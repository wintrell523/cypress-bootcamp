...
it('class, id, attr', { baseUrl: '' }, () => {
	...
	cy.get('h1') // označenie pomocou tagu
...
it('nested classes', { baseUrl: '' }, () => {
	...
	cy.get('.green.circle') // označ zelený kruh

	cy.get('.green .circle') // označ kruh, ktorý je vo vnútri niečoho zeleného

	cy.get('.green > .circle') // označ kruh, ktorý je hneď prvá vec v niečom zelenom
})
